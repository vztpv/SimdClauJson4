...
public:
    ...
    inline const std::unique_ptr<char[]>& raw_buf() const noexcept {
        return loaded_bytes;
    }
    ...
    inline const std::unique_ptr<internal::dom_parser_implementation>& raw_implementation() const noexcept {
        return implementation;
    }

    inline const size_t raw_len() const noexcept {
        return len;
    }
